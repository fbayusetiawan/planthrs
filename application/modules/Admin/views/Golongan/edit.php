            ...
            <div class="card-body">
                <form class="needs-validation" novalidate="" action="<?= base_url($linkin . '/editAction/' . $this->uri->segment(4)) ?>" method="post">
                    <div class="form-group mb-3">
                        <label for="validationCustom01">Nama Golongan</label>
                        <input type="text" name="namaGolongan" value="<?= $row->namaGolongan ?>" id="validationCustom01" class="form-control" required>
