            ...
            <div class="card-body">
                <form class="needs-validation" novalidate="" action="<?= base_url($linkin . '/editAction/' . $this->uri->segment(4)) ?>" method="post">
                    <div class="form-group mb-3">
                        <label for="validationCustom01">Nama Section</label>
                        <input type="text" name="namaSection" value="<?= $row->namaSection ?>" id="validationCustom01" class="form-control" required>
