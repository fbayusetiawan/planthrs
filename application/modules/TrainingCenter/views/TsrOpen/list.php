                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group mb-0">
                                        ...
                                        <a href="<?= base_url($linkin . '/delete/' . $row->idKaryawan) ?>" id="<?= $row->idKaryawan ?>" class="delete-data btn btn-info btn-sm" data-toggle="tooltip" title="Hapus"><i class="uil uil-trash-alt"></i></a>
                                    </div>
                                </td>
                            </tr>
                        <?php endforeach ?>
