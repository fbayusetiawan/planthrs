...
class DetailPart extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('DetailPart_m', 'primaryModel');
    }
    public $titles = 'Part';
    ...
    function addPart()
    {
        ...
        $array = array(
            'idDetailBacklog' => $this->uri->segment(4),
            'problemDesc' => $this->uri->segment(5)
        );

        $this->session->set_userdata($array);

        redirect('Backlog/DetailBacklog/addPart');
    }
