...
<div class="card">
    <div class="card-body">
        ...
        <div class="form-group mb-3">
                ...
                <input type="text" class="form-control" value="<?= $row->partNumber ?>" name="partNumber" required>
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" class="form-control" value="<?= $row->partDescription ?>" name="partDescription" required>
                <div class="invalid-feedback">
                    Harus diisi!
                </div>
            </div>
            <div class="form-group mb-3">
                ...
                <input type="text" class="form-control" value="<?= $row->mnemonic ?>" name="mnemonic" required>
                <div class="invalid-feedback">
                    Harus diisi!
                </div>
            </div>
            <div class="form-group mb-3">
                ...
                <input type="text" class="form-control" value="<?= $row->material ?>" name="material" required>
                <div class="invalid-feedback">
                    Harus diisi!
                </div>
            </div>
