...
class SubKomponenMayor extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('SubKomponenMayor_m', 'primaryModel');
    }
    public $titles = 'TSR - Sub Komponen Mayor';
    public $vn = 'SubKomponenMayor';
