...
class TsrKondisiPermukaan extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('TsrKondisiPermukaan_m', 'primaryModel');
    }
    public $titles = 'TSR - Kondisi Permukaan';
    public $vn = 'TsrKondisiPermukaan';
